...
function esteem_customizer_custom_scripts() { ?>
	<style>
		...
		li#accordion-section-esteem_important_links h3.accordion-section-title, li#accordion-section-esteem_important_links h3.accordion-section-title:focus {
			background-color: #ED564B !important;
			color: #fff !important;
		}

		li#accordion-section-esteem_important_links h3.accordion-section-title:hover {
			background-color: #ED564B !important;
			color: #fff !important;
		}

		li#accordion-section-esteem_important_links h3.accordion-section-title:after {
			color: #fff !important;
		}
