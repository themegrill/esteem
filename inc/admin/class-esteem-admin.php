...
if ( ! class_exists( 'Esteem_Admin' ) ) :
	...
	class Esteem_Admin {
		...
		public function admin_menu() {
			...
			$page = add_theme_page(
				esc_html__( 'About', 'esteem' ) . ' ' . $theme->display( 'Name' ),
				esc_html__( 'About', 'esteem' ) . ' ' . $theme->display( 'Name' ),
				'activate_plugins',
				'esteem-welcome',
				array(
		...
		public function enqueue_styles() {
			...
			wp_enqueue_style( 'esteem-welcome', get_template_directory_uri() . '/css/admin/welcome.css', array(), ESTEEM_THEME_VERSION );
		}
		...
		private function intro() {
			...
			$major_version = substr( ESTEEM_THEME_VERSION, 0, 3 );
			?>
			...
			<h2 class="nav-tab-wrapper">
				<a class="nav-tab
				<?php
				if ( empty( $_GET['tab'] ) && $_GET['page'] == 'esteem-welcome' ) {
					echo 'nav-tab-active';
				}
				?>
